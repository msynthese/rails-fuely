...
class StationsService
  ...
  def self.find(lat, lon)
    ...
    url = "https://public.opendatasoft.com/api/records/1.0/search/?dataset=prix_des_carburants_j_7&q=&lang=fr&facet=cp&facet=pop&facet=city&facet=automate_24_24&facet=fuel&facet=shortage&facet=update&facet=services&facet=brand&facet=ville&facet=adresse&geofilter.distance=#{lat.to_f}%2C+#{lon.to_f}%2C3000"
